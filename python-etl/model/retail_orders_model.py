...
class OrderModel:
    def __init__(self, data: str):
        ...
        self.pay_total = data['payedTotal']                    # 已付款金额（目标表是 pay_total）
    ...
    def generate_insert_sql(self):
        ...
        INSERT IGNORE INTO {conf.target_orders_table_name} (
            ...
            pay_total, pay_type, payment_channel, payment_scenarios, product_count,
            date_ts
        ) VALUES (
            {check_str_null_and_transform_to_sql_null(str(self.order_id))}, 
            {check_str_null_and_transform_to_sql_null(str(self.store_id))}, 
            ...
            {check_str_null_and_transform_to_sql_null(str(self.store_own_user_id))}, 
            ...
            {check_str_null_and_transform_to_sql_null(str(self.store_gps_longitude))}, 
            {check_str_null_and_transform_to_sql_null(str(self.store_gps_latitude))}, 
            {check_str_null_and_transform_to_sql_null(str(self.is_signed))}, 
            ...
            {check_str_null_and_transform_to_sql_null(str(self.member_id))}, 
            {check_str_null_and_transform_to_sql_null(str(self.store_create_date_ts))}, 
            {check_str_null_and_transform_to_sql_null(str(self.origin))}, 
            {check_str_null_and_transform_to_sql_null(str(self.day_order_seq))}, 
            {check_str_null_and_transform_to_sql_null(str(self.discount_rate))}, 
            {check_str_null_and_transform_to_sql_null(str(self.discount_type))}, 
            {check_str_null_and_transform_to_sql_null(str(self.discount))},
            {check_str_null_and_transform_to_sql_null(str(self.money_before_whole_discount))}, 
            {check_str_null_and_transform_to_sql_null(str(self.receivable))}, 
            {check_str_null_and_transform_to_sql_null(str(self.erase))}, 
            {check_str_null_and_transform_to_sql_null(str(self.small_change))}, 
            {check_str_null_and_transform_to_sql_null(str(self.total_no_discount))},
            {check_str_null_and_transform_to_sql_null(str(self.pay_total))}, 
